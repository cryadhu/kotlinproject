package com.kotlinproject.cr.ui.main.adapter
...
class DataAdapter(private val users: ArrayList<User>) : RecyclerView.Adapter<DataAdapter.DataViewHolder>() {
